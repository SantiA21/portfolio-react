...
export function SkillBadge({ name, icon, color }: SkillBadgeProps) {
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-xl bg-zinc-800/50 backdrop-blur-sm border border-zinc-700/50 p-6 h-full transition-all duration-300 hover:border-blue-500/50 group">
